export default {
  bsvPayment: {
    ...
    airGap: {
      ...
      signerButton: '扫码签名',
      watchOnlyNoKey: '观察模式无私钥，请在持有私钥的设备上扫码签名',
      sender: {
        title: '发起离线签名转账',
        recipientLabel: '收款方',
        ...
        buildButton: '生成待签名交易',
        buildingButton: '生成中…',
        showPsbtTitle: '用签名设备扫此码',
        showPsbtDesc: '在持有私钥的设备上打开"扫码签名"，扫描此码完成签名。',
        scanSignedTitle: '扫描签名码',
        scanSignedDesc: '签名设备完成签名后会展示一个二维码，扫描它即可广播交易。',
        broadcasting: '广播中…',
        broadcastSuccess: '广播成功',
        rewrite: '重新填写',
        scanBack: '已签名，扫回',
        scanSignedButton: '扫描签名码',
        back: '返回',
        done: '完成',
        sendLabel: '发送',
        feeShortLabel: '手续费',
        ...
        unrecognizedQr: '未识别的二维码，请扫描签名设备生成的签名码',
      ...
      signer: {
        ...
        scanPsbtDesc: '扫描发起方设备展示的待签名二维码。',
        confirmTitle: '确认交易',
        feeLabel: '手续费',
        totalLabel: '合计',
        signingHint: '签名中，请输入 PIN…',
        showSignedTitle: '用发起方设备扫此码',
        showSignedDesc: '将此码展示给发起方设备扫描，即可自动广播交易。',
        scanButton: '扫描待签名码',
        confirmButton: '确认并签名',
        rescan: '重新扫描',
        resign: '重新签名',
        ...
        unrecognizedQr: '未识别的二维码，请扫描发起方设备生成的待签名码',
        parsePsbtFailed: '待签名码解析失败',
        expiredWarning: '注意：此交易创建于 {{minutes}} 分钟前，UTXO 可能已过期，建议回到发起方重新生成。',
        steps: ['扫待签码', '确认', '签名', '出示签名码'],
      },
    },
    qrScanner: {
      hint: '将二维码放入框内',
