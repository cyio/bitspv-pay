...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg",
  {
    variants: {
      ...
      animated: {
        true: "transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
        false: "",
      },
    },
    compoundVariants: [
...
interface SheetContentProps
  extends React.ComponentPropsWithoutRef<typeof SheetPrimitive.Content>,
    Omit<VariantProps<typeof sheetVariants>, "animated"> {
  animated?: boolean
}
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", animated = true, className, children, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    <SheetPrimitive.Content
      ref={ref}
      className={cn(sheetVariants({ side, animated }), className)}
      {...props}
    >
